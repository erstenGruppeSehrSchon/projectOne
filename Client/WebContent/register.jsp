				...
				<table>
					...
					<tr>
						...
						<td><input type="password" id="clientPassword"
							name="clientPassword" class="form-control"></td>
					</tr>
					<tr>
						<td><h4 class="form_title">Re-enter Password</h4></td>
						<td><input type="password" id="clientrePassword"
							name="clientPassword" class="form-control"></td>
						<td><p id="validate-status" style="color: red;"></p></td>
					</tr>
					<tr>
						<td><h4 class="form_title">Gender</h4></td>
						<td><select type="select" id="clientGender"
							name="clientGender" class="form-control">
					...
					<tr>
						...
						<td><input type="text" id="clientBirthDate"
							name="clientBirthDate" class="form-control"></td>
					</tr>
					<tr>
						<td rowspan="2"><input type="submit" value="Register"
