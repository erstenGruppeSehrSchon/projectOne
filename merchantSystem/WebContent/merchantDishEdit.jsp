...
<header>
  ...
  <div id="main">
	...
	<input type="hidden" value = "${shopId}" id = "dishesRegShopId" name = "shopId"/>
	<input type="hidden" value = "${dishId}" id = "dishId" name = "dishId"/>
	<table>
	<tr>
		<td>Dish Name</td>
		<td><input type = "text" class = "form-control" name = "dishName"/></td>
	</tr>
	<tr>
		<td>Dish Type</td>
		<td>
	...
	<tr>
		<td>Dish Prices</td>
		<td><input type = "text" name="dishPrice" class = "form-control"/></td>
	</tr>
	<tr>
		<td>Is Active</td>
		<td>
